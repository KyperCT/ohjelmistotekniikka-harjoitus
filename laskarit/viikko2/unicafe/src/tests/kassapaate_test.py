...
class TestKassapaate(unittest.TestCase):
    ...
    def test_edullinen_vaihtoraha_oikein_kun_maskaa(self):
        self.assertEqual(self.kassapaate.syo_edullisesti_kateisella(250), 10)

    def test_maukas_vaihtoraha_oikein_kun_maskaa(self):
    ...
    def test_edullinen_vaihtoraha_oikein_kun_ei_maskaa(self):
        self.assertEqual(self.kassapaate.syo_edullisesti_kateisella(230), 230)

    def test_maukas_vaihtoraha_oikein_kun_ei_maskaa(self):
    ...
    def test_maukas_kateinen_kun_ei_on_raha(self):
        self.kassapaate.syo_maukkaasti_kateisella(4)
        self.assertEqual(self.kassapaate.kassassa_rahaa, 100000)
